...
import { AtomicQueryMTPV2PubSignals, BaseConfig } from '@0xpolygonid/js-sdk';
export declare class AtomicQueryMTPV2PubSignalsVerifier extends IDOwnershipPubSignals implements PubSignalsVerifier {
    ...
    verifyQuery(query: Query, schemaLoader?: DocumentLoader, verifiablePresentation?: JSON, opts?: VerifyOpts): Promise<BaseConfig>;
