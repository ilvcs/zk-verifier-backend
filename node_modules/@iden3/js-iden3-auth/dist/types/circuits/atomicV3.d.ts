...
import { AtomicQueryV3PubSignals, BaseConfig, JSONObject } from '@0xpolygonid/js-sdk';
/**
...
export declare class AtomicQueryV3PubSignalsVerifier extends IDOwnershipPubSignals implements PubSignalsVerifier {
    ...
    verifyQuery(query: Query, schemaLoader?: DocumentLoader, verifiablePresentation?: JSON, opts?: VerifyOpts, params?: JSONObject): Promise<BaseConfig>;
