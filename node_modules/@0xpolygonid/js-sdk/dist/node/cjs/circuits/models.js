...
class Query {
    ...
    validateValueArraySize(maxArrSize) {
        switch (this.values.length) {
            case 0: {
                const zeroArrSizeOps = [comparer_1.Operators.NOOP, comparer_1.Operators.SD, comparer_1.Operators.NULLIFY];
            ...
            case 2: {
                const twoArrSizeOps = [comparer_1.Operators.BETWEEN, comparer_1.Operators.NONBETWEEN];
            ...
            default: {
                const maxArrSizeOps = [comparer_1.Operators.IN, comparer_1.Operators.NIN];
