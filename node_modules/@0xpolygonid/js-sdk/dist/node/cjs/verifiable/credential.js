...
class W3CCredential {
    ...
    async verifyCoreClaimMatch(coreClaim, merklizeOpts) {
        ...
        switch (merklizedPosition) {
            case js_iden3_core_1.MerklizedRootPosition.None:
                merklizedRootPosition = constants_1.MerklizedRootPosition.None;
                break;
            case js_iden3_core_1.MerklizedRootPosition.Index:
                merklizedRootPosition = constants_1.MerklizedRootPosition.Index;
                break;
            case js_iden3_core_1.MerklizedRootPosition.Value:
        ...
        switch (idPosition) {
            case js_iden3_core_1.IdPosition.None:
