...
export declare const parseCredentialSubject: (credentialSubject?: JSONObject) => PropertyQuery[];
...
export declare const parseQueriesMetadata: (credentialType: string, ldContextJSON: string, credentialSubject: JSONObject, options: Options) => Promise<QueryMetadata[]>;
