...
export declare const findValue: (fieldName: string, credential: W3CCredential) => JSONObject;
export declare const createVerifiablePresentation: (context: string, tp: string, credential: W3CCredential, queries: QueryMetadata[]) => object;
