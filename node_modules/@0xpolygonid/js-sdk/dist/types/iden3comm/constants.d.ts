...
export declare const PROTOCOL_MESSAGE_TYPE: Readonly<{
    ...
    CREDENTIAL_REFRESH_MESSAGE_TYPE: string;
    ...
    CONTRACT_INVOKE_REQUEST_MESSAGE_TYPE: string;
    CREDENTIAL_ONCHAIN_OFFER_MESSAGE_TYPE: string;
    PROPOSAL_REQUEST_MESSAGE_TYPE: string;
    PROPOSAL_MESSAGE_TYPE: string;
    PAYMENT_REQUEST_MESSAGE_TYPE: string;
    PAYMENT_MESSAGE_TYPE: string;
}>;
/**
